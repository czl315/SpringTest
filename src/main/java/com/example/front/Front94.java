...
public class Front94 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(1, 12, 14, 26, 27);// 1,12,14,26,27+07 09
		int[] filtersLast = { 16, 17, 26, 29, 35 };// 过滤上期 TODO
		...
		int[] filtersAdjoin3 = { 17, 25, 28 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 2, 11, 13, 16, 18, 30, 33, 34 };// 过滤规律重复1, 27;上次重号，本次不再重号
		...
		int[] kill360Array = { 31, 23, 29, 25, 35, 24, 33, 24, 35, 9 };// 360杀号定胆
		int[] killcjw = { 29, 12, 10, 03, 13, 19, 8, 1, 17, 13 };// 杀号-彩经网
