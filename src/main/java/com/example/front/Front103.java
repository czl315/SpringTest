...
public class Front103 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(5, 12, 22, 27, 32);// 19103:::5,12,22,27,32+4,7
		int[] filtersLast = { 5, 10, 15, 19, 31 };// 过滤上期 TODO
		...
		int[] filtersAdjoin3 = { 9, 20 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 5, 10, 15, 18, 19, 20, 27 };// 过滤规律重复1, 27;上次重号，本次不再重号
		int[] filtersMost = { 29, 33, 35 };// 出现总次数：29=352；33=341；35=328；32=321；30=312；35遗漏39期处于历史峰值
		int[] filtersCool = { 7, 24, 32 };// 遗漏次数：7=25;24=17;32=17
		int[] kill360Array = { 15, 31, 28, 28, 28, 2, 28, 26, 16, 34 };// 360杀号定胆
		int[] killcjw = { 31, 11, 22, 26, 22, 18, 14, 10, 5, 17 };// 杀号-彩经网
