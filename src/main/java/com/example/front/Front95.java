...
public class Front95 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(3, 12, 17, 19, 31);// 19095:::3,12,17,19,31+2,6
		int[] filtersLast = { 1, 12, 14, 26, 27 };// 过滤上期 TODO
		...
		int[] filtersAdjoin3 = { 28 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 1, 4, 26, 27, 28, 30 };// 过滤规律重复1, 27;上次重号，本次不再重号
		int[] filtersMost = { 29, 33, 35 };// 出现总次数：29=352；33=341；35=328；32=321；30=312；35遗漏39期处于历史峰值
		int[] filtersCool = { 3, 22, 8 };// 遗漏次数：3=25;22=21;8=18;
		int[] kill360Array = { 31, 19, 12, 31, 24, 24, 20, 31, 28, 19 };// 360杀号定胆
		int[] killcjw = { 24, 35, 11, 15, 11, 34, 30, 18, 14, 18 };// 杀号-彩经网
