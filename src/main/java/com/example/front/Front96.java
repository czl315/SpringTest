...
public class Front96 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(2, 12, 22, 23, 27);// 19096:2,12,22,23,27+2,6
		int[] filtersLast = { 3, 12, 17, 19, 31 };// 过滤上期 TODO
		...
		int[] filtersRuleRepeat = { 12, 13, 26, 27 };// 过滤规律重复1, 27;上次重号，本次不再重号
		int[] filtersMost = { 29, 33, 35 };// 出现总次数：29=352；33=341；35=328；32=321；30=312；35遗漏39期处于历史峰值
		int[] filtersCool = { 22, 8, 7 };// 遗漏次数：22=24;8=21;7=20;
		int[] kill360Array = { 26, 25, 6, 4, 29, 7, 4, 2, 6, 29 };// 360杀号定胆
		int[] killcjw = { 32, 2, 12, 29, 32, 20, 13, 27, 33, 28 };// 杀号-彩经网
