...
public class Front98 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(13, 15, 17, 19, 22);// 19098：13,15,17,19,22+3,4
		int[] filtersLast = { 10, 17, 20, 30, 35 };// 过滤上期 TODO
		...
		int[] filtersRuleRepeat = { 10, 15, 19, 27 };// 过滤规律重复1, 27;上次重号，本次不再重号
		...
		int[] kill360Array = { 21, 29, 23, 29, 19, 17, 26, 17, 32, 25 };// 360杀号定胆
		int[] killcjw = { 16, 32, 29, 14, 19, 19, 26, 29, 18, 30 };// 杀号-彩经网
