...
public class Front113 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(3, 11, 27, 34, 35);// 19113:::3,11,27,34,35+1,2
		int[] filtersLast = { 3, 10, 16, 21, 33 };// 过滤上期 TODO
		...
		int[] filtersAdjoin3 = { 17, 22 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 6, 19, 20, 27 };// 过滤规律重复1, 27;上次重号，本次不再重号
		int[] filtersMost = { 29, 33, 35 };// 出现总次数：29=352；33=341；35=328；32=321；30=312；35遗漏39期处于历史峰值
		int[] filtersCool = { 29, 16, 26 };// 遗漏次数：29=15;16=15;26=14;
		int[] kill360Array = { 1, 25, 25, 12, 25, 17, 20, 25, 27, 2 };// 360杀号定胆
		int[] killcjw = { 12, 10, 1, 5, 29, 16, 6, 29, 4, 23 };// 杀号-彩经网
