...
public class Front112 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(3, 10, 16, 21, 33);// 19112:::3,10,16,21,33+5,6
		int[] filtersLast = { 6, 15, 20, 23, 27 };// 过滤上期 TODO
		...
		int[] filtersAdjoin3 = { 21, 22 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 8, 17, 19, 23, 24, 27, 28 };// 过滤规律重复1, 27;上次重号，本次不再重号
		...
		int[] kill360Array = { 20, 15, 24, 10, 13, 18, 12, 17, 24, 12 };// 360杀号定胆
		int[] killcjw = { 23, 32, 19, 8, 29, 21, 29, 32, 33, 15 };// 杀号-彩经网
