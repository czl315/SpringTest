 ...
 * @author admin
 */
public class DaFrontUtil19044a1 {
	...
	public static void main(String[] args) {
		...
		frontAreaLimit.setSumMinLimit(60);// 2018年前区和值：40以下-0；5X-8；6X-11；7X=12；8X=31；9X=29；10X=22；11X=20；12X=5；13X=4；14X=2；
		...
		int[] filtersAdjoin3 = {11};// 过滤3adjoin
