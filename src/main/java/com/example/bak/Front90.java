...
public class Front90 {
	...
	public static void main(String[] args) {
		...
		FrontBall curBall = new FrontBall(13, 19, 28, 30, 33);// 19090:::13,19,28,30,33+2,12
		...
		frontLimit.setSumMaxLimit(81);

		int[] filtersAdjoin3 = { 35 };// 过滤3adjoin-特殊形态;三邻号
		int[] filtersRuleRepeat = { 5, 6, 16, 18, 24, 28, 31 };// 过滤规律重复1, 27;上次重号，本次不再重号
		int[] filtersMost = { 29, 33 };// 出现总次数：29=352；33=341；35=328；32=321；30=312；35遗漏39期处于历史峰值
		int[] filtersCool = { 3, 22, 2 };// 遗漏次数：3=17;27=16;22=13
		int[] kill360Array = { 6, 9, 31, 13, 29, 9, 18, 10, 25, 25 };// 360杀号定胆
		int[] killcjw = { 6, 5, 17, 13, 9, 5, 28, 24, 12, 8 };// 杀号-彩经网
