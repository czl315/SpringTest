 ...
 * @author admin
 */
public class DaFrontUtil1903700 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 */
		List<FrontBall> combs = combNolian(curBall, sumMinLimit, sumMaxLimit, filterHists, filterBalls, kuaduMin,
				kuaduMax, oddLimit, evenLimit, frontAreaLimit);// 精确匹配多个
