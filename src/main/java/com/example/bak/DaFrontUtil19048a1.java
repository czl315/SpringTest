 ...
 * @author admin
 */
public class DaFrontUtil19048a1 {
	...
	public static void main(String[] args) {
		// 当期2019041
		FrontBall curBall = new FrontBall(6, 10, 16, 29, 33);
		...
		int[] filtersMost = { };// 出现总次数：29=349；33=338；35=324；32=321；30=312；35遗漏39期处于历史峰值
