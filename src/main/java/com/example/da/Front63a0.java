...
public class Front63a0 {
	...
	public static void main(String[] args) {
		 ...
		 * 剩余组合
		 */
		List<FrontBall> combs = combNolian(curBall, filterHists, kuaduMin, kuaduMax, oddLimit, evenLimit,
				frontLimit);// 精确匹配多个
	 ...
	 * @return
	 */
	private static List<FrontBall> combNolian(FrontBall curBall, List<FrontBall> filterHists, 
