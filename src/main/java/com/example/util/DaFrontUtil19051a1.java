 ...
 * @author admin
 */
public class DaFrontUtil19051a1 {
//	private static boolean showLast = false;
	...
	public static void main(String[] args) {
		...
		frontLimit.setF1Max(12);// 1-7百分比=1240/1819=68.17%
		...
		int[] filtersMost = {  33 };// 出现总次数：29=349；33=338；35=324；32=321；30=312；35遗漏39期处于历史峰值
