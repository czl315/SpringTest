...
public class BackHis {
	...
	public static List<BackBall> backBallLast2019(int limitCount) {
		...
		for (int i = 1; i <= limitCount; i++) {
			...
			if (i == 54)
				rs2019.add(new BackBall(5, 10));
			if (i == 53)
				rs2019.add(new BackBall(11, 12));
			if (i == 52)
				rs2019.add(new BackBall(7, 11));
			if (i == 51)
			...
			if (i == 35)
				rs2019.add(new BackBall(8, 9));
			if (i == 36)
				rs2019.add(new BackBall(1, 12));
			if (i == 37)
				rs2019.add(new BackBall(4, 8));
			if (i == 38)
				rs2019.add(new BackBall(7, 12));
			if (i == 39)
				rs2019.add(new BackBall(6, 12));
